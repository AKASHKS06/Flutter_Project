...
class _ChefLoginWidgetState extends State<ChefLoginWidget> {
  ...
  void _submitForm() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SignupuserWidget()),
      );
    }
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      SvgPicture.asset('assets/images/chflgn/vector.svg', height: 24),
                      SizedBox(width: 20),
                      SvgPicture.asset('assets/images/chflgn/vector5.svg', height: 24),
                      SizedBox(width: 20),
                      SvgPicture.asset('assets/images/chflgn/vector6.svg', height: 24),
                    ],
                  ),
                ],
              ),
