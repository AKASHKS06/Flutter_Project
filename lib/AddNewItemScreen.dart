            ...
            children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(child: Icon(Icons.add, color: Colors.purple)),
                        ),
                        SizedBox(width: 8),
                        Container(
                          width: 100,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  filled: true,
                  fillColor: Colors.white,
                  hintText: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Bibendum in vel, mattis et amet dui mauris turpis.',
                  border: OutlineInputBorder(),
                ),
              ),
              SizedBox(height: 16),
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => RestaurantViewScreen()),
                    );
                  },
...
class SubmitConfirmationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Your item has been submitted!'),
      ),
    );
  }
}
